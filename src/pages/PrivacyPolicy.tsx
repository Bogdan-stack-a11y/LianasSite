        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-text-muted font-light leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>«Администрация сайта» – уполномоченные сотрудники на управления сайтом, действующие от имени ФЛ Гетман Лиана, которые организуют и (или) осуществляет обработку персональных данных.</li>
